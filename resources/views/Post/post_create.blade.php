...
@section('content')
    .<div class="container">
        ...
        <div class="card card-body">
                <h2 class="d-flex justify-content-center m-3">Create Post Form</h2>
            ...
            <form action="{{ url('post-store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row mt-2">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputPassword" placeholder="Detalails " name="details">
                    </div>
                </div>
                ...
                <div class="form-group row mt-2">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" id="inputPassword" placeholder="User Id" name="user_id">
                    </div>
                </div>
                ...
                <div class="form-group row mt-2">
                    ...
                    <div class="col-sm-10">
                        <input type="file" class="form-control-file" id="inputPassword" placeholder="" name="image">
                    </div>
                </div>
